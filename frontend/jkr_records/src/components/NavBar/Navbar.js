        ...
        <nav className='nav-main'>
            ...
            <div >
                <ul id="navbar" className={clicked ? "navbar active" : "navbar"}>
                    ...
                    {!isAuthenticated && <li><a href='/login' className={location.pathname === '/login' ? 'active' : ''}>Login</a></li>}
                    {!isAuthenticated && <li><a href='/register' className={location.pathname === '/register' ? 'active' : ''}>Register</a></li>}
