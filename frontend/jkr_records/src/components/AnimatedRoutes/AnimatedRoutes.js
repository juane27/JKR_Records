...
function AnimatedRoutes() {
  ...
  const isAuthenticated = useSelector(state => state.auth.isAuthenticated); // Obtén el estado de autenticación del store
...
return (
  ...
  <Route path="/giveaway" element={isAuthenticated ? <GiveawayPage /> : <LoginPage />} />
